...
function skillBlock(): string {
  return [
    ...
    "Pahami tujuan produk, fitur, dan tech stack-nya dulu sebelum mulai kerja. PENTING: pakai PERSIS",
    "tech stack yang tertulis di section \"Arsitektur Sistem & Tech Stack\" PRD ini untuk SEMUA task —",
    "jangan improvisasi framework/library lain walau menurutmu ada yang \"lebih cocok\", supaya",
    "implementasi antar task tetap konsisten.",
    "",
